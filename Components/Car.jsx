...
const Car = () => {
  ...
  return (
    <>
      <div className='carBlack bg-[#F6F6F6] w-full h-[100vh] flex items-center justify-center'>
        <div className='blackcome relative w-[90%] h-[80%] bg-[#282524] flex items-center justify-center'>
          <div className='blackAnimate absolute top-10 w-[80%] h-[60%]'>
            ...
            <div className='absolute top-20 -left-10 textAnimate'>
              ...
              <p className='font-extralight tracking-[.3] text-white text-[5vw] leading-[5vw]'>
                Creative design, 3D <br /> animation & modern CMS
              </p>
              <a href="#" className='uppercase text-white font-bold border-b-2 border-white pb-1 mt-[1vw] inline-block'>
                View Projects
              </a>
            </div>
          </div>
