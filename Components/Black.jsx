                        ...
                        <div className='flex g-red-900 gap-10 w-full h-full  z-10 absolute top-0 left-0 am:pt-20 bg-ble-900'>
                            <div className='w-1/2 h-full am:pl-2 pl-20'>
                                ...
                                <div className='text-white'>
                                    ...
                                    <a href="" className='mt-[1.5vw] inline-block  font-["Giloy "] font-bold  border-b-2 border-white '>VIEW SERVICES</a>
                                </div>
                            ...
                            <div className=' h-full b-blue-900 '>
                                <div className='   absolute bottom-20 right-5 am:bottom-[4vw]  z-[0] am:ml-[40vw]'>
                                    ...
                                    <h4 className='ml-32 am:ml-0 font-["Gilroy "] am:text-[4.5vw] am:leading-none -mt-[3vw] text-white leading-[1.3vw] text-[1.3vw] am:bg-red-900'>increase in prospective <br /> employee engagement</h4>
                                </div>
                            </div>
                        </div>
                    </div>
